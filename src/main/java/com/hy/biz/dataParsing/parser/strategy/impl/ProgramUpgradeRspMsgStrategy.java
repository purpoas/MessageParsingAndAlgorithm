 ...
 * @package com.hy.biz.dataParsing.parser.strategy.impl
 * @description
 * @create 2023-05-23 09:48
 **/
public class ProgramUpgradeRspMsgStrategy implements CtrlMsgParserStrategy {
    ...
    public JsonObject parse(ByteBuffer buffer, ParserHelper parserHelper, String messageSignature, String deviceCode, long timeStamp) {
        return parserHelper.createJsonMsg(buffer, messageSignature, deviceCode, timeStamp, "程序升级");
    }

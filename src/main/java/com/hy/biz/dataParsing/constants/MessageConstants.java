...
public final class MessageConstants {
    ...
    public static final String DTO_TO_JSON_ERROR = "无法将设备上线线DTO转换为设定的 JSON 格式 -> 系统报错: ";
    public static final String MESSAGE_TO_DEVICE_ONLINE_STATUS_DTO_ERROR = "订阅频道中收到的 JSON 数据无法转换为设备上下线DTO -> 系统报错: ";
    ...
    public static final String UNABLE_TO_PARSE = "无法解析该报文";
